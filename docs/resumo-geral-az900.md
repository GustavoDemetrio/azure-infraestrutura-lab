...
![Criação da VM](images/vms.png)

### Configuração de Rede
![Ícone de criação de Rede](images/redes.png)
![Configuração da Rede](images/configrede.png)

### VM pronta no Bastion
![VM conectada no Bastion](images/vmpronta.png)

### Armazenamento
![Conta de Armazenamento criada](images/Storage.png)
![Arquivos no Armazenamento](images/arqstorage.png)
